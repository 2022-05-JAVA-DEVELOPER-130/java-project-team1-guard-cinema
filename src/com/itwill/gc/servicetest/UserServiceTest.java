...
<<<<<<< HEAD
	...
	public static void main(String[] args) throws Exception {
		...
		int rowCount = userService
				.create(new User("qwer", "김씨", "01071719139", "9510011111111", "qwer@naver.com", "5432"));
		System.out.println(">> " + rowCount);

		System.out.println("로그인");
		int result = userService.login("qwer", "5432");
		...
		rowCount = userService.update(new User("rewq", "씨김", "01071719319", "9510012222222", "rewq@naver.com", "2345"));
		System.out.println(">> " + rowCount);
		System.out.println("   " + userService.findUser("kkkk1"));
