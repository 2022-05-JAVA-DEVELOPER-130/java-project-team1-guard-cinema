...
public class GuardMainFrame extends JFrame {
	...
	*************************/
	...
	public GuardMainFrame() throws Exception {
		...
		lblNewLabel_12_1_2
				.setIcon(new ImageIcon(GuardMainFrame.class.getResource("/team1_movie_image/토르 러브 앤 썬더.jpg")));
		...
		lblNewLabel_12_1_1_1_1
				.setIcon(new ImageIcon(GuardMainFrame.class.getResource("/team1_movie_image/버즈 라이트이어.jpg")));
		...
		cinemaNameCB.setModel(new DefaultComboBoxModel(
				new String[] { "가산디지털", "가양", "강동", "건대입구", "김포공항", "노원", "도곡", "독산", "브로드웨이", "서울대입구", "수락산", "수유",
						"신도림", "신림", "에비뉴엘", "영등포", "용산", "월드타워", "은평", "중랑", "청량리", "합정", "홍대입구" }));
		cinemaNameCB.setBounds(28, 341, 100, 23);
		reserveOnePanel.add(cinemaNameCB);

		JComboBox cinemaPlaceCB = new JComboBox();
		cinemaPlaceCB.setModel(
				new DefaultComboBoxModel(new String[] { "1관", "2관", "3관", "4관", "5관", "6관", "7관", "8관", "9관" }));
		...
		btnNewButton_23.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				movieReserve = new MovieReserve(0, movieItem.getI_day(), movieItem.getI_seat(),
						movieItem.getI_daytime(), movieItem.getI_price(), movieItem.getI_cname(),
						movieItem.getI_cplace(), new Movie(movieItem.getI_code()), new User(loginUser.getUserId()));
		...
		q_oneCateCB.setModel(new DefaultComboBoxModel(
				new String[] { "대분류1", "대분류2", "대분류3", "대분류4", "대분류5", "대분류6", "대분류7", "대분류8", "대분류9", "대분류10", "" }));
		q_oneCateCB.setBounds(82, 56, 75, 23);
		questionPanel.add(q_oneCateCB);

		JComboBox q_twoCateCB = new JComboBox();
		q_twoCateCB.setModel(new DefaultComboBoxModel(
				new String[] { "소분류1", "소분류2", "소분류3", "소분류4", "소분류5", "소분류6", "소분류7", "소분류8", "소분류9", "소분류10" }));
		...
		q_insertBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Question newQuestion = new Question(0, new User(loginUser.getUserId()), qTitle, qContent, qCateOne,
							qCateTwo, null);
		...
		questionListTable.setModel(new DefaultTableModel(new Object[][] { { null, null, null, null, null },
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null },
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null },
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null },
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null },
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null }, },
				new String[] { "\uBC88\uD638", "\uB300\uBD84\uB958", "\uC18C\uBD84\uB958", "\uC81C\uBAA9",
						"\uB4F1\uB85D\uC77C" }));
	...
	public void seatListDisplay() throws Exception {
		...
		String cinema_place=movieItem.getI_cplace();
		String daytime=movieItem.getI_daytime();
	...
	public void gongjiListDisplay() throws Exception {
		...
		DefaultTableModel defaultTableModel = new DefaultTableModel(gongjiListVector, columnVector);
	...
	public void faqListDisplay() throws Exception {
		...
		DefaultTableModel defaultTableModel = new DefaultTableModel(faqListVector, columnVector);
